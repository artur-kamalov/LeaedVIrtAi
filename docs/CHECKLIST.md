...
- [x] Added Telegram login account switching: API exposes public bot id, `/login` clears the current LeadVirt session, opens Telegram OAuth logout in a top-level popup before choosing another account, and regular Telegram callbacks remain accepted.
