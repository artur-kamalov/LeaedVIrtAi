      ...
      <header className="fixed top-0 inset-x-0 z-50 border-b border-white/5 bg-zinc-950/60 backdrop-blur-xl">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Button variant="ghost" size="sm" onClick={() => go("dashboard")}>Войти</Button>
            <Button size="sm" onClick={() => go("onboarding")}>Попробовать бесплатно</Button>
          </div>
          ...
          >
            <nav className="container mx-auto px-6 py-6 flex flex-col gap-4 text-zinc-300">
              ...
              <div className="flex flex-col gap-3 pt-2">
                <Button variant="outline" size="md" onClick={() => go("dashboard")}>Войти</Button>
                <Button size="md" onClick={() => go("onboarding")}>Попробовать бесплатно</Button>
              </div>
            </nav>
          </motion.div>
        )}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                <Button size="lg" className="w-full sm:w-auto group" onClick={() => go("onboarding")}>
                  Попробовать бесплатно
                  <ChevronRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                </Button>
                <Button variant="outline" size="lg" className="w-full sm:w-auto" onClick={() => go("dashboard")}>
                  Смотреть демо
                </Button>
              </div>
            </motion.div>
        ...
        <section className="py-32 container mx-auto px-6 relative">
          ...
          <div className="max-w-4xl mx-auto text-center bg-zinc-900 border border-zinc-800 rounded-[3rem] p-12 md:p-20 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <Button size="lg" className="h-16 px-10 text-lg w-full sm:w-auto shadow-[0_0_40px_rgba(52,211,153,0.3)]" onClick={() => go("onboarding")}>
