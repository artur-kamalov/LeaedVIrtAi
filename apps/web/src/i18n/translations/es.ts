...
export const es: Record<TranslationKey, string> = {
  ...
  "landing.features.crm.description": "El historial de conversaciones, las etiquetas, los contactos y las reservas fluyen automáticamente a su CRM (AmoCRM, Bitrix24, Yclients y más).",
  ...
  "landing.metrics.integrations.label": "Integraciones listas",
  ...
  "landing.cta.note": "Prueba gratuita de 7 días. No se requiere tarjeta de pago.",
  ...
  "pricing.note": "Cada plan incluye una prueba gratuita de 7 días. No se requiere tarjeta de pago.",
  "pricing.perMonth": "por mes",
  "pricing.start.tagline": "Para pequeñas empresas que prueban un flujo de trabajo de IA",
  "pricing.start.cta": "Comenzar con Inicio",
  ...
  "pricing.corporate.cta": "Contáctenos",
  ...
  "auth.login.subtitle": "Utilice Telegram para abrir su espacio de trabajo.",
  ...
  "auth.signup.subtitle": "Cree un espacio de trabajo con Telegram y continúe con la configuración.",
  ...
  "auth.hero.description": "Inicio de sesión sin contraseña: Telegram verifica tu identidad y LeadVirt abre el espacio de trabajo de tu organización.",
  "auth.highlight.passwordless": "Sin contraseña",
  "auth.highlight.telegram": "Inicio de sesión verificado de Telegram",
  "auth.highlight.database": "Espacio de trabajo respaldado por base de datos",
  ...
  "auth.error.login": "No se pudo iniciar sesión con Telegram",
  ...
  "product.newLead": "Nuevo cliente potencial",
  ...
  "dashboard.action.newLead": "Nuevo cliente potencial",
