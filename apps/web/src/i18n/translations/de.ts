...
export const de: Record<TranslationKey, string> = {
  ...
  "auth.login.subtitle": "Verwenden Sie Telegram, um Ihren Arbeitsbereich zu öffnen.",
  ...
  "auth.signup.subtitle": "Erstellen Sie einen Arbeitsbereich mit Telegram und fahren Sie mit der Einrichtung fort.",
  ...
  "auth.hero.description": "Passwortlose Anmeldung: Telegram bestätigt Ihre Identität und LeadVirt öffnet den Arbeitsbereich Ihrer Organisation.",
  "auth.highlight.passwordless": "Passwortlos",
  "auth.highlight.telegram": "Verifizierter Telegram-Login",
  ...
  "auth.error.login": "Anmeldung mit Telegram nicht möglich",
